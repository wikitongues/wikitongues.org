...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20211024_wikitongues_e0d420a529917e6e7066_20231010231158_archive.zip';
        const ARCHIVE_SIZE       = '291012536';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'e0d420a-10231158';
        const SECONDARY_PACKAGE_HASH = 'db58e5d-10231158';
        const VERSION            = '1.5.6';
