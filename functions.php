...
function create_post_type_grantees()
{
    ...
    register_post_type('grantees',
        ...
        'labels' => array(
            ...
            'add_new_item' => __('Add New Project', 'grantees'),
            'edit' => __('Edit', 'grantees'),
            'edit_item' => __('Edit Project', 'grantees'),
            'new_item' => __('New Project', 'grantees'),
            'view' => __('View Project', 'grantees'),
            'view_item' => __('View Project', 'grantees'),
