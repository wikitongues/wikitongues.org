...
function handle_document_download() {
	if ( ! isset( $_POST['file_id'] ) ) {
			wp_send_json_error( array( 'message' => 'Invalid file request.' ) );
	}
	...
	wp_send_json_success( array( 'file_url' => esc_url( site_url( '/force-download/?file_id=' . $file_id ) ) ) );
}
