...
2. **Report results clearly:**
   ...
   - On full pass: one-line summary, e.g. "All checks passed — lint ✓, analyse ✓, 66 tests ✓"
...
- `composer analyse` runs PHPStan with the baseline at `phpstan-baseline.neon` — new suppressions require updating the baseline
